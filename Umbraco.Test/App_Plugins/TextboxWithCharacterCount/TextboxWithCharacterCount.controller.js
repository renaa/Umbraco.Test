function textBoxWithCharacterCount($scope) {
    ...
    $scope.update = function () {
        ...
        $scope.model.remainingCount = $scope.model.config.maxcount - $scope.model.value.length
...
angular
    .module("umbraco")
    .controller("tfr.TextboxWithCharacterCount", textBoxWithCharacterCount);